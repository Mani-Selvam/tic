...
const styles = {
    ...
    noData: { color: "#cbd5e1", fontStyle: "italic", fontSize: "13px" },
    mono: { fontFamily: "'JetBrains Mono', monospace", color: "#4f46e5", fontWeight: 600, fontSize: "13px" },
    ...
    emptyStateIcon: { fontSize: "52px", marginBottom: "18px", opacity: 0.6 },
    emptyStateTitle: {
        fontSize: "20px",
        fontWeight: "700",
        margin: "0 0 10px 0",
    ...
    confirmHeader: { padding: "20px 24px", borderBottom: "1px solid #f1f5f9" },
    confirmTitle: {
        margin: 0,
        fontSize: "17px",
        fontWeight: "700",
    ...
    confirmBody: { padding: "20px 24px", fontSize: "15px", color: "#475569", lineHeight: 1.6 },
    confirmFooter: {
        padding: "16px 24px",
        background: "#f8fafc",
        display: "flex",
