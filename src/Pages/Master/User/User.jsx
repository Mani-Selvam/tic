                ...
                {loading ? (
                    ...
                    <>
                                        ...
                                        <tr key={row._id}>
                                            ...
                                            <td>
                                                <div className="action-btns">
                                                    <button className="action-btn edit-btn" onClick={() => openView(row)} title="View">
                        ...
                        <div className="mobile-cards">
                            {filtered.map((row, i) => (
                                <div key={row._id} className="record-card">
                                    <div className="record-card-header">
                                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                                            <Avatar name={row.name} />
                                            <div>
                                                <div className="record-card-title">{row.name}</div>
                                                <div className="record-card-subtitle">{row.email}</div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="record-card-body">
                                        <div className="record-card-field">
                                            <span className="record-card-label">Mobile</span>
                                            <span className="record-card-value">{row.mobile || "-"}</span>
                                        </div>
                                        <div className="record-card-field">
                                            <span className="record-card-label">Company</span>
                                            <span className="record-card-value">{row.companyId?.name || "-"}</span>
                                        </div>
                                        <div className="record-card-field full-width">
                                            <span className="record-card-label">Designation</span>
                                            <span className="record-card-value">{row.designationId?.name || "-"}</span>
                                        </div>
                                    </div>
