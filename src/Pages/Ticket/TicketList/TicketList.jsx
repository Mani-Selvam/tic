...
const TicketList = () => {
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            if (createForm.company_id)
                fd.append("company_id", createForm.company_id);
            fd.append("department_id", createForm.department_id);
            if (createForm.priority_id)
                fd.append("priority_id", createForm.priority_id);
            if (createForm.status_id)
                fd.append("status_id", createForm.status_id);
            if (createForm.location) fd.append("location", createForm.location);
            if (createForm.assigned_to)
                fd.append(
                    "assigned_to",
                    JSON.stringify([createForm.assigned_to]),
                );
    ...
    const filtered = tickets.filter((t) => {
        ...
        const priorityMatch =
            !filters.priority ||
            String(t.priority_id?._id || t.priority_id || "") ===
                filters.priority;
        const statusMatch =
            !filters.status ||
                        ...
                        <div className="cp-grid">
                            ...
                            <div className="form-group">
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        sf("department_id", e.target.value)
                                    }
                                    required>
                                    ...
                                    <tr key={ticket._id || i}>
                                        ...
                                        <td>
                                            {ticket.priority_id?.name ? (
                                                <span
                                                    className={`ticket-badge ${pBadge(ticket)}`}>
                                                    {ticket.priority_id.name}
                                                </span>
                                            ) : (
                                                <span
                                        ...
                                        <td>
                                            {ticket.status_id?.name ? (
                                                <span className="ticket-badge badge-status">
                                                    {ticket.status_id.name}
                                                </span>
                                            ) : (
                                                <span
